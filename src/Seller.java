...
class Seller extends User implements Payable {
    ...
    void addProduct() {
        ...
        sellerProducts.add(new Product(productID, name, price, quantity, description));
        ItemCollections.products.add(new Product(productID, name, price, quantity, description));
